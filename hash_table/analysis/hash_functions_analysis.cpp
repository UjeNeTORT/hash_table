                                  ...
                                  const size_t               hash_table_size)
{
    ...
    size_t n_words = 0;
    fscanf (preprocessed_target_data_file, "%ld", &n_words);
    ...
    for (size_t n_hf = 0; n_hf < n_hash_functions; n_hf++)
    {
        ...
        ret_val += AnalyzeHashFunction (analysis_results_paths[n_hf],
                                        ptd_aligned,
                                        n_words * PTD_ALIGNMENT * sizeof(char),
                                        hash_functions[n_hf],
                                        hash_table_size);
                         ...
                         size_t             hash_table_size)
{
    ...
    HashTableLoadTargetDataAligned (hash_table, ptd_aligned, target_data_size);

    fprintf (results_file, "id, n\n");
